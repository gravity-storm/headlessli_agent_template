...
name: headlessli
description: >
  Use this skill when the user wants to build a website powered by a headless CMS,
  integrate Headless.li into a project, connect any GraphQL-based CMS (DatoCMS,
  Contentful, Storyblok, Hygraph, or similar) to a Next.js or React frontend,
  generate typed CMS-driven components, or use the @qoh ecosystem.
  Activate when the user mentions "headless CMS", "Headless.li", "CMS integration",
  "@qoh", "QueenofheartsService", "build a website", or asks to connect their CMS
  to their frontend.
---
